...
import './CinemaPres.css';
/* import photoCinema from 'images/CinemaPres/salle_cine_presentation.jpeg'; */
/* import photoCine1 from 'images/CinemaPres/photocine1.jpg'; */
/* import photoCine2 from 'images/CinemaPres/photocine2.jpg';
import photoCine3 from 'images/CinemaPres/photocine3.jpeg'; */

class CinemaPres extends Component {

  render() {
    return (
      <div className="pageCinema">

        <div><img id="photoCinema" src='images/CinemaPres/salle_cine_presentation.jpeg' alt="photo salle cinema Tchi Tcha" />
        </div>
        <h1 id="titleCine">Le Tchi Tcha</h1>

        <div id="main">
          <div id="partie1">
            <img id="photoCine1" src='images/CinemaPres/photocine1.jpg' alt="" />
          ...
          <div id="partie2">
            <img id="photoCine2" src='images/CinemaPres/photocine2.jpg' alt="" />
          ...
          <div id="partie3">
            <img id="photoCine3" src='images/CinemaPres/photocine3.jpeg' alt="" />

...
export default class SessionsAdminMenu extends Component {
  
    render() {
      return (
        <ul className="header-menu horizontal-list">
              <li>
                  <Link to='/' className="header-menu-tab" href="#1"><span className="icon entypo-cog scnd-font-color"></span>Ajouter</Link>
              </li>
              <li>

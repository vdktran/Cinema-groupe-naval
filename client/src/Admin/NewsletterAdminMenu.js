...
export default class NewsletterAdminMenu extends Component {

    render() {
        return (
            <ul className="header-menu horizontal-list">
                <li>
                    <Link to='/' className="header-menu-tab" href="#1"><span className="icon fontawesome-envelope scnd-font-color"></span>Envoyer</Link>
                </li>
                <li>
